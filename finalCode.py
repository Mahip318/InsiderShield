# -*- coding: utf-8 -*-
"""
Shellhacks Final Shellhacks code
Started by : Mahi
...
user_transfer_frequencies.to_csv('userDataTransfer.csv', index=False)
...
user_login_activity_df.to_csv('log_data.csv', index=False)
